...
# Title: Generador onda senosoidal
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Generador onda senosoidal", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Generador onda senosoidal")
        ...
        self._tuning_range = Range(5400000000, 5800000000, 200000, 5600000000, 200)
        ...
        self._samp_rate_range = Range(120000, 5000000, 1000, 384000, 200)
        ...
        self._rf_gain_range = Range(0, 60, 1, 40, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, tuning, 1, 0, 0)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_0, 0), (self.qtgui_sink_x_0_0, 0))
